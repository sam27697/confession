// Shared tail of every login path (Facebook OAuth, Google OAuth and the
// dev login), spec
// §3.4 steps 1-3: resolve identity, then either sign in an existing account
// or stash the identity for /onboarding to create one. Used by all of
// app/auth/facebook/callback, app/auth/google/callback and app/auth/dev so
