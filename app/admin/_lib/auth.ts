...
// Requires a valid, non-disabled admin session; otherwise 307 to
// /admin/login (spec §3.2, §3.3). Callers reach this only once
// env.adminEnabled has already been checked (spec §3.0's kill switch), so
// this function itself does not repeat that check.
